---
title: Face shields
description: Produção colaborativa de face shields impressas em 3D para proteger profissionais de saúde em Joinville durante a pandemia de COVID-19.
category: maker
tags:
  - 3d-printer
  - maker
...
![Face shield pronta para distribuição, com instruções de uso e higienização](./face-shield-distribuicao.webp)
...
![Impressoras 3D produzindo as estruturas das face shields](./impressoras-3d-face-shields.webp)

Depois da impressão, voluntários montavam as estruturas, fixavam as viseiras e preparavam os equipamentos para entrega.

![Voluntários montam face shields no Fab Lab Joinville](./montagem-face-shields.webp)
...
![Caixas identificadas com face shields prontas para entrega](./caixas-face-shields.webp)

![Entrega de face shields à Secretaria de Saúde de Joinville](./entrega-face-shields.webp)
...
![Equipe de voluntários envolvida na produção das face shields](./equipe-face-shields.webp)
